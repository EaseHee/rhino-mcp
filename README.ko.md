...
| 사용 사례                                | 명령어                                                                            |
|------------------------------------------|----------------------------------------------------------------------------------|
| Stdio (Claude Desktop 기본)              | `uvx rhino-mcp` *또는* `rhino-mcp`                                              |
...
mcp-inspector, Continue, Claude Code 등 서브프로세스를 spawn할 수 있는 모든 MCP 호환 클라이언트에서 동작합니다 — `uvx rhino-mcp` 또는 설치된 `rhino-mcp` 엔트리포인트 경로를 지정하고 아래 환경 변수 표를 참고하세요.
