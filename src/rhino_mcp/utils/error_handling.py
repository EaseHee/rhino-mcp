...
def connection_error(detail: str = "") -> ToolError:
    return ToolError(
        ...
        (
            "Start Rhino 8, run `_-RunPythonScript rhino_plugin/RhinoMCPBridge.py`, "
...
def unsupported_in_standalone(tool: str) -> ToolError:
    return ToolError(
        ...
        "Start Rhino 8 + RhinoMCPBridge and re-run; rhino3dm standalone cannot perform this operation.",
